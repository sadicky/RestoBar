...
$datas=$trans->select_all_ag($acc->getAccId(),'paiement_fournisseur');
?>
<div class="white-box">
                            <h3 class="box-title m-b-0">Paiements (Historique récente)</h3>
                            <hr>
                            <p><a href="javascript:void(0)" class="btn btn-primary btn-rounded" id="add_pyt"> <i class="fa fa-plus"></i> Ajouter</a></p>

                            <div class="table-responsive">
							 <table id="example2" class="table table-bordered table-condensed display" cellspacing="0" width="100%">
							 <thead>
                                        <tr>
                                            <th>Date</th><th>Montant</th><th>Statut</th><th>Pre-balance</th><th>Post-Balance</th><th>Fournisseurs</th><th>Agent (Caisse)</th>
                                        </tr>
                            </thead>
                                    <tfoot>
                                        <tr>
