...
/*if(empty($_GET['four']))
{*/
$datas=$op->select_all_by_period('Sortie',$_GET['from_d'],$_GET['to_d'],$_GET['pos']);
//}
/*else
{
...
<div class="alert alert-info" style="background-color: white;" id="appro_tab">
                            <h4 class="box-title m-b-0">Bon de Sortie Du <?php echo $_GET['from_d']; ?>: Au: <?php echo $_GET['to_d']; ?> / Stock :
                                <?php
                            ...
                            <div class="table-responsive">
							 ...
							 <thead>
                                <tr>
                    <th>#N°</th><th>Date/Heure</th><th>Type</th><th>Article</th><th>Par</th>
                                        </tr>
                            </thead>
                                    ...
                                    {*/
                                    echo '<button class="btn btn-light btn-sm row_edit_sort_hist" style="cursor:pointer" data-id="'.$un['op_id'].'"><i class="fa fa-edit fa-fw" ></i></button>';
                                    //}
                                    echo $sortie->getNumSort().'</td><td>'.date('Y-m-d h:i',strtotime($un['create_date'])).'</td><td>'.$sortie->getMotif().'</td>';
                                    ...
                                    echo '</ul>
                                    <a href="javascript:void(0)" title="Imprimer" class="btn btn-light btn-sm print_sort" id="'.$un['op_id'].'"><i class="fa fa-print"></i></a>
