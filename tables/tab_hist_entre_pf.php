...
/*if(empty($_GET['four']))
{*/
$datas=$op->select_all_by_period('Production',$_GET['from_d'],$_GET['to_d'],$_GET['pos']);
//}
/*else
{
...
<div class="alert alert-info" style="background-color: white;" id="appro_tab">
                            ...
                            <div class="table-responsive">
							 ...
							 <thead>
                                <tr>
                    <th>#N°</th><th>Date/Heure</th><th>MP</th><th>PF</th><th>Par</th>
                                        </tr>
                            </thead>
                                    ...
                                    {
                                    echo  '<button class="btn btn-light btn-sm row_edit_entre_hist" style="cursor:pointer" data-id="'.$un['op_id'].'"><i class="fa fa-edit fa-fw" ></i></button>';
                                    }
                                    ...
                                    echo '</ul>
                                    <a href="javascript:void(0)" title="Imprimer" class="btn btn-light btn-sm print_entre" id="'.$un['op_id'].'"><i class="fa fa-print"></i></a>
