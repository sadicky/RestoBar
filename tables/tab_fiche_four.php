...
$track=new BeanPayTrack();
 ...
 $datas=$op->select_all_party('Approvisionnement',$_GET['four'],$_SESSION['pos']);

?>
<div class="white-box row">
<div class="col-md-12">
<div class="alert alert-info" style="background-color: white;" id="appro_tab">
                    <h3>FICHE DU FOURNISSEUR</h3><hr>
                            <h4 class="box-title m-b-0">Fourniture De <?php

                            $pers->select($_GET['four']);
               ...
               <thead>
                                <tr>
                    <th>RDV DE PAIEMENT</th><th>#N°</th><th>Date/Heure</th><th>Total</th><th width="200">Payé</th><th>Dû</th><th>Article</th><th>Par</th>
                                        </tr>
                            </thead>
                  ...
                  <?php
                                    ...
                                    {
                                    echo '<tr><td class="row_achat" style="cursor:pointer" data-id="'.$un['op_id'].'">  ';

                                    if(!empty($days))
                                    {
                                    echo '<i class="fa fa-hand-o-right fa-fw"></i> <span style="color:';
                                    ...
                                    elseif($achat->getAmount() - $amount['paie']>0)
                                     {
                                        echo '<i class="fa fa-hand-o-right fa-fw"></i> <button class="btn btn-light btn-sm row_pay_date" data-id="'.$un['op_id'].'"><i class="fa fa-calendar"></i> Date Paiement</button>';
                                    }
                                    else
                                    {
                                        echo '--';
