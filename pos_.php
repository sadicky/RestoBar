...
<div class="jumbotron row pt-0 pb-0 bg-axel  text-dark" style="margin-bottom:0">
  ...
  <div class="col-md-10">
  <h1 id="soft_title" style="font-size: 30px; font-weight: bold; color:#0c5285;" class="text-center"><i>My Market POS</i></h1><hr>
  <div class="row">
    <div class="col-md-4 m-2 p-2 text-dark bg-box-axel">
                    <p>Utilisateur : <span id="sess_name"><?php echo $personne->getNomComplet(); ?></span></p>
                    
                    <p>Fonction : <?php echo $auth_user->getTypeUser(); ?></p>
  </div>
      ...
      <span id="display_journal">
                  <p><?php
                    ...
                    <?php
                        ...
                        else { ?> Journal courant Depuis : <?php echo $jour->getStartDate(); ?>
                        <?php
                        }
                    ?></p>
      </span>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-top-menu border border-success">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0" id="frm_search_mat" action="javascript:void(0)" method="POST">
      ...
      <!-- <button type="button" class="btn btn-sm btn-light" id="tab_exp_prod">
          <i class="fa fa-battery-0" style="color:red"></i> <span class="badge badge-light"><?php //echo $check->select_nb_exp_prod_stk('90'); ?></span>
      </button> -->
...
<div class="col-md-11 mt-2" id="page-content" style="font-size: 13px;">

</div>
</div>

<div class="jumbotron text-center bg-footer text-white" style="margin-bottom:0">
  <p>Copyright 2019 <b><span class="text-danger">Mulfam</span><span class="text-dark">Company</span></b> /Developped by Yaredi M. Tél: (+257) 79 756 874</p>
</div>
