...
<div class="card card-info" >
                            <div class="card-header bg-light">Categorie* : <span id="prod_cat"></span> /Bon de Sortie stock N°  : #<span id="num_sort"><?php if(isset($_SESSION['sort_num'])){echo $_SESSION['sort_num'];}else {echo '?';} ?></span></div>
                            <div>
                                <div class="card-body">
                                    <form id="sort_mat_form" method="post">
                                        <div class="form-body">
<div class="form-row">
    <div class="col-md-8">
