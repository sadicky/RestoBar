...
<div id="myModalPayCust" class="modal">
    ...
    <div class="modal-content">
        <div class="modal-header">
            <h3 style="text-align: center">Paiement Hotel</h3>
            ...
            <tbody>
                ...
                $datas=$trans->select_all_op($opId);
                   ...
                   $tot +=$value['amount'];
                       ...
                       echo '<button class="btn btn-danger btn-sm del_pay_cust_hot" data-id="'.$value['transaction_id'].'"><i class="fa fa-times"></i></button>';
                       echo '</td></tr>';   
