<input type="hidden" name="vente" id="direct2">
<div id="myModalAutFV" class="modal">
    <!-- Modal content -->
    <div class="modal-content">
        <div class="modal-header">
            <h3 style="text-align: center">Autres Frais : Fact No : <?php echo $vente->getNumVente(); ?></h3>
            <span class="close text-danger">&times;</span>
        </div>
        <div class="p-1 mb-2 m-0" style="border: 1px gray solid; border-radius: 5px;">
            <form action="javascript:void(0)" id="frm_autre_frais_v" method="post" enctype="multipart/form-data" class="form-horizontal">
                <div class="row">
                    ...
                    <div class="col col-md-3">
                        ...
                        <select id="aut_det" name="aut_det" class="custom-select" required>
                                    ...
                                    <?php
                                    $dat = array('Impots & Taxes','Transport','Communication','Autres Frais');
                    ...
                    <div class="col col-md-3">
                        <input type="hidden" id="op_id" name="op_id" value="<?php if(isset($_SESSION['op_vente_id'])) {echo $_SESSION['op_vente_id']; }?>">
            ...
            <h3>Autre Frais</h3>
                <table class="table table-bordered table-sm">
                    ...
                    <tbody>
                        ...
                        {
                        $dat=$aut->select_all_op($_SESSION['op_vente_id']);
