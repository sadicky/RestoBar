...
<div class="card card-info" >
                            <div class="card-header bg-light">Historique périodique de Production</div>
                            <div >
                                <div class="card-body">
                                    <form id="frm_search_hist_entre_pf" method="post">
                                        <div class="form-body">
<div class="form-row">
    <div class="col-md-3">
    ...
    <div class="col-md-2">
        <div class="form-group">
            ...
            <input type="date" id="datepicker" name="from" class="form-control" value="<?php echo date("Y-m-d"); ?>" required>
        </div>
    </div>
    <div class="col-md-2">
        <div class="form-group">
            <label class="control-label">Au : </label>
            <input type="date" id="datepicker2" name="to" class="form-control" value="<?php echo date('Y-m-d', strtotime(date("Y-m-d"). ' + 1 days')); //echo date("Y-m-d"); ?>" required>
        </div>
    </div>
    <div class="col-md-2" >
