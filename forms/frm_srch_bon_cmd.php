...
<div class="card card-info" >
                            <div class="card-header bg-light">Fourniture périodique</div>
                            <div >
                                <div class="card-body">
                                    <form id="frm_search_bon_cmd" method="post">
                                        <div class="form-body">
<div class="form-row">
    <div class="col-md-3">
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <select class="form-control" id="four_hist" name="four">
...
<section class="row">
<div class="col-lg-12" >
<div class="alert alert-info" style="background-color: white;" id="tab_bon_cmd">
